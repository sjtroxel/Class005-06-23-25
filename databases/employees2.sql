...
INSERT INTO Employees2 (EmployeeID, LastName, FirstName, BirthDate, Notes)
VALUES (1, 'Doe', 'John', '1990-01-01', 'John Doe was born on January 1, 1990.');
INSERT INTO Employees2 (EmployeeID, LastName, FirstName, BirthDate, Notes)
...
SELECT FirstName, COUNT(*) FROM Employees2 GROUP BY FirstName;
SELECT FirstName, COUNT(*) FROM Employees2 GROUP BY FirstName ORDER BY COUNT(*) ASC;
SELECT FirstName, COUNT(*) FROM Employees2 GROUP BY FirstName HAVING COUNT(*) > 1;